                    ...
                    <table class="table bg-white rounded shadow-sm  table-hover display-product-table ">
                        ...
                        <tbody>
                            <tr v-for="list in lists">
                                ...
                                <th>
                                    <button @click="viewUser(list.userid)" class="btn btn-success"  data-bs-toggle="modal" data-bs-target="#viewUser">View User</button>
                                    <button @click="showReserve(list.reserve_id)"  class="btn btn-info mx-3"   data-bs-toggle="modal" data-bs-target="#showDetail">Show Details</button>
                                      <button  @click="deleteReservation(list.reserve_id)"  class="btn btn-danger"  id="delete"> Delete</button> 
                                </th>
                            </tr>
