                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover ">
                            ...
                            <tbody>
                                <tr v-for="user in users" :key="user.id">
                                    ...
                                    <td>
                           <a class="float-end mt-3" @click="fnGetUsers(user.userid)" data-bs-toggle="modal" data-bs-target="#updateSt">
                                    <i class="fas fa-edit" style="color: green;"></i>
                                </a>

                                <a class="float-end mt-3 me-2" @click="DeleteUser(user.userid)" id="delete">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content p-4s">
                            <div class="modal-header">
                                <h5 class="text-dark">Update User</h5>
