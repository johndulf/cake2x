...
<body>  <!-- header section start here  -->
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <div class="dropdown">
                <a class="dropdown-toggle"  data-bs-toggle="dropdown" aria-expanded="false">Account</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12 p-5">
                    ...
                    <div class="form-group">
                        <input class="mb-4 p-3"  type="date" name="date" placeholder="date" style="font-size:15px; font-family:emoji;margin-right:5px;" v-model="date" />
                        <input class="mb-4 p-3"  type="number" name="mobile" placeholder="Phone Number" style="font-size:15px; font-family:emoji;" v-model="mobile" />
                    </div>
                        ...
                        <input type="number" name="price" readonly :value="price" class="form-control mb-4" style="font-size:15px; font-family:emoji;">
                        <select name="flavor" id="flavor" class="form-control mb-4" style="font-size:15px; font-family:emoji;">
